...
export default function DetailsRight({ user, price, city, isLiked, toggleLike, share}){
    ...
    <div className="hidden lg:block lg:w-[35%] min-w-0">
      <div className="sticky top-[120px] z-[999] mt-3 rounded-lg border bg-white shadow-sm w-full h-auto">
        ...
        <div className="p-4">
          ...
          <div
            onClick={toggleLike}
            className={`my-3 flex flex-row items-center rounded-lg border p-2 cursor-pointer`}
          >
            {isLiked
          ...
          <div onClick={share} className="my-3 flex flex-row items-center rounded-lg border p-2 cursor-pointer">
